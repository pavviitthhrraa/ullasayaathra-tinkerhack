...
function showDestinationScreen() {
    ...
    document.getElementById('step-content').innerHTML = `
        ...
        <div class="input-group">
            ...
            <input type="text" placeholder="To — Your destination">
        </div>
...
function showPathChoiceScreen() {
    document.getElementById('step-content').innerHTML = `
        ...
        <div class="path-options">
            <div class="path-card" onclick="alert('Generating Normal Plan...')">
                <span class="emoji">📋</span>
                <h3>The Normal Plan</h3>
                <p>See your full itinerary upfront. Classic and reliable.</p>
            </div>
            <div class="path-card surprise" onclick="alert('Activating Ottamind Mystery Mode!')">
                <span class="emoji">🎴</span>
                <h3>The Ottamind Plan</h3>
                <p>Mystery mode! Only Day 1 is revealed. Unlock the rest by checking in.</p>
                <span class="badge">✦ Surprise Mode</span>
            </div>
        </div>`;
}
